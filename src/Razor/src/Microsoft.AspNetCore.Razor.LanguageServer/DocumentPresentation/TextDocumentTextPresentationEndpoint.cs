...
namespace Microsoft.AspNetCore.Razor.LanguageServer.DocumentPresentation
{
    internal class TextDocumentTextPresentationEndpoint : AbstractTextDocumentPresentationEndpointBase<TextPresentationParams>, ITextDocumentTextPresentationHandler
    {
        ...
        public override RegistrationExtensionResult? GetRegistration(ClientCapabilities clientCapabilities)
        {
        ...
        public override object? GetTextDocumentIdentifier(TextPresentationParams request)
        {
