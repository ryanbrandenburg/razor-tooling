...
namespace Microsoft.AspNetCore.Razor.LanguageServer.Debugging
{
    internal class RazorBreakpointSpanEndpoint : IRazorBreakpointSpanEndpoint
    {
        ...
        public async Task<RazorBreakpointSpanResponse?> HandleRequestAsync(RazorBreakpointSpanParamsBridge request, RazorRequestContext requestContext, CancellationToken cancellationToken)
        {
