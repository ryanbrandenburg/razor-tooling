...
namespace Microsoft.AspNetCore.Razor.LanguageServer.Formatting
{
    internal class RazorDocumentRangeFormattingEndpoint : IVSDocumentRangeFormattingEndpoint
    {
        ...
        public TextDocumentIdentifier GetTextDocumentIdentifier(DocumentRangeFormattingParamsBridge request)
        {
            return request.TextDocument;
        }

        public async Task<TextEdit[]?> HandleRequestAsync(DocumentRangeFormattingParamsBridge request, RazorRequestContext requestContext, CancellationToken cancellationToken)
        {
