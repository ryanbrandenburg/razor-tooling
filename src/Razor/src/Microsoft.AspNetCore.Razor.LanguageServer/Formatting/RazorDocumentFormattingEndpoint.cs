...
namespace Microsoft.AspNetCore.Razor.LanguageServer.Formatting
{
    internal class RazorDocumentFormattingEndpoint : IVSDocumentFormattingEndpoint
    {
        ...
        public async Task<TextEdit[]?> HandleRequestAsync(DocumentFormattingParamsBridge request, RazorRequestContext requestContext, CancellationToken cancellationToken)
        {
