...
namespace Microsoft.AspNetCore.Razor.LanguageServer.ProjectSystem
{
    internal abstract class RazorProjectService
    {
        ...
        public abstract DocumentSnapshot OpenDocument(string filePath, SourceText sourceText, int version);

        public abstract void CloseDocument(string filePath);

        public abstract void RemoveDocument(string filePath);

        public abstract DocumentSnapshot UpdateDocument(string filePath, SourceText sourceText, int version);
